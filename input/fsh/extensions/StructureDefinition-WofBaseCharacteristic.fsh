...
* extension[scheduling].extension[schedulingAvailability].valueCodeableConcept.coding.system =  Canonical(WCCharacteristic) (exactly)
...
* extension[scheduling].extension[bookingConfirmation].valueCoding.system =  Canonical(WCCharacteristic) (exactly)
