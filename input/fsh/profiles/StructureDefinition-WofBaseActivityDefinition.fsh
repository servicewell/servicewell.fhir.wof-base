...
* meta.profile ^definition = "Identifies that the resource conforms to WofBaseActivityDefinition so clients can safely process it as the WOF concept profile."
...
* title ^definition = "The user-facing title used to present the service concept in search results, booking flows, and other views."
