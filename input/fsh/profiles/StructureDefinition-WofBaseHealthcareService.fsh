...
* id ^definition = "The logical id of this WofBaseHealthcareService resource. It identifies the specific care offering location instance within the system."
* meta.profile 1..* MS
* meta.profile ^short = "Profile declaration for this resource"
* meta.profile ^definition = "Identifies that the resource conforms to WofBaseHealthcareService so clients can safely process it as the WOF concept profile."
...
* name ^definition = "The human-readable name used to present the healthcare service"
* active 1..1
...
* telecom 0..*
* telecom ^short = "Contact details for the healthcare service"
...
* availableTime ^definition = "Opening hours and other published availability windows for when the healthcare service is available."

* photo 0..1
* photo ^short = "Image representing the healthcare service"
* photo ^definition = "Attachment carrying binary image data that represents the healthcare service."
* contained 0..*
